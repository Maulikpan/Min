        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8'>
          {
            books.map(book => <Card>
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400">
                ...
                <StripeCheckout stripeKey='pk_test_51PCegjSBS6VjnK9nN6mB3DXRP33MaO7N9juXYkz6eAQRa7khsEFWDIVopqEYG6IUdgcBSTqTnBUidwj8K85G7E0V004Kf15dOU' token={makePayment} name='Buy Book' amount={'₹250'}>
